...
<div class="parallax cover overlay cover-image-full home">
    <img class="parallax-layer" src="images/backpack.jpg" alt="Learning Cover" />
    <div class="parallax-layer overlay overlay-full overlay-bg-white bg-transparent" data-speed="8" data-opacity="true">
      <div class="v-center">
        <div class="page-section overlay-bg-white-strong relative paper-shadow" data-z="1">
                <img src="/images/pin_blue.png" height="60%" width="60%">
            <h1 class="text-display-2 margin-v-0-15 display-inline-block">Pinnock's Education Center</h1>{{--
...
<!--Featured Courses-->
  <div class="page-section bg-white">
    <div class="container">
      ...
      <div class="slick-basic slick-slider" data-items="4" data-items-lg="3" data-items-md="2" data-items-sm="1" data-items-xs="1">
        ...
        @include('layouts.f_job_item',['lessonName'=>'Github for beginners','icon'=>'fa fa-github','stars'=>2])
       <!--Featured Item-->
        <div class="item">
          <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated>
            <div class="panel-body">
  ...
  <div class="parallax cover overlay height-300 margin-none">
    <img class="parallax-layer" data-auto-offset="true" data-auto-size="false" src="images/book.jpg" alt="Learning Cover" />
...
{{-- 
                ...
                <div id="content">
                        <div class="container-fluid">
                          ...
                          <div class="lock-container">
                            <div class="panel panel-default text-center paper-shadow" data-z="0.5">
                              ...
                              <img src="images/pin_blue.png" class="img-circle width-90">
                              <div class="panel-body">
                                <div class="form-group">
                  ...
                  <div class="form-group form-control-material">
                    <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required type="text" id="wiz-email"  placeholder="Email" />
                ...
                @endif
                  ...
                  <div class="form-group form-control-material">
                    <input class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" type="password" id="wiz-password" name="password" placeholder="Password" />
                ...
                @endif
                  ...
                  <div class="form-group form-control-material">
                    <input class="form-control " type="password" id="wiz-password2" placeholder="Confirm Password" name="password_confirmation" required/>
                  ...
                  <div class="form-group form-control-material">
                    <input class="form-control {{ $errors->has('fname') ? ' is-invalid' : '' }}" name="fname" value="{{ old('fname') }}" required autofocus type="text" id="wiz-fname" placeholder="First name" />
                ...
                @endif
                  ...
                  <div class="form-group form-control-material">
                    <input class="form-control{{ $errors->has('lname') ? ' is-invalid' : '' }}" name="lname" value="{{ old('lname') }}" required autofocus type="tel" id="wiz-lname" placeholder="Last name" />
                ...
                @endif
                  ...
                  <div class="form-group form-control-material">
                    <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" required type="text" id="wiz-phone" placeholder="Phone" />
                    <label for="wiz-phone">Phone:</label>
                    @if ($errors->has('phone'))
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $errors->first('pphone') }}</strong>
                    </span>
                @endif
                  </div>
                  <div class="form-group form-control-material">
                    <textarea rows="5" class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}" value="{{ old('address') }}" id="wiz-address" name="address" placeholder="Your address"></textarea>
                ...
                @endif
                  ...
                  <div class="form-group form-control-material">
                        <select name="account_type" class="selectpicker" id="account_type" data-style="btn-white"  data-size="5" required>
